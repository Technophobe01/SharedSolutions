...
/* package challenge-wc-0.1.0.0 */
#ifndef VERSION_challenge_wc
#define VERSION_challenge_wc "0.1.0.0"
#endif /* VERSION_challenge_wc */
#ifndef MIN_VERSION_challenge_wc
#define MIN_VERSION_challenge_wc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_challenge_wc */
...
#define CURRENT_COMPONENT_ID "challenge-wc-0.1.0.0-inplace-challenge-wc"
